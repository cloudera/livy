...
import com.cloudera.livy.client.LivyScalaClient
...
class ScalaTestClient extends FunSpecLike with ScalaFutures {

  import com.cloudera.livy.client.LivyScalaConverter._

  private val timeout = 40
  private var client: LivyScalaClient = _

  describe("Test Scala API") {

    it("test Job Submission") {
...
object ScalaTestClient {
  ...
  def fileOperation(isResource: Boolean, fileName: String, context: JobContext): String = {
