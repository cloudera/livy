...
import com.cloudera.livy.client.rsc.driver.RSCDriverBootstrapper;
import com.cloudera.livy.client.rsc.rpc.Rpc;
import com.cloudera.livy.client.rsc.rpc.RpcDispatcher;
import com.cloudera.livy.client.rsc.rpc.RpcServer;
import static com.cloudera.livy.client.rsc.RSCConf.Entry.*;
  ...
  private static ChildProcess startDriver(
    ...
    if (livyJars == null) {
      ...
      if (!rscJars.isDirectory()) {
        rscJars = new File(livyHome, "client-rsc/target/jars");
      }
